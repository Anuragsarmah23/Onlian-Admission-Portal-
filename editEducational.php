                ...
                <div class="row">
                   <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="updateParse.php">
                                    <div class="row">
                                        <div class="col-md-6">
									...
									<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>COURSE</label>
												<input type="hidden" name="courseAdE" value="<?php echo $row2['name']; ?>">
                                                <select name="courseAd" id="courseAd" disabled class="form-control" required>
										...
										<?php if( ($row2["name"] == "bsc") || ($row2["name"] == "msc") || ($row2["name"] == "ma") || ($row2["name"] == "ba")){ ?>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label id="majorL">MAJOR</label>
                                                <select name="major" id="major" disabled class="form-control">
													<option value="<?php echo $row2["major"]; ?>"><?php echo $row2["major"]; ?></option>
												</select>
											</div>
                                        </div>
										<?php } ?>
                                    ...
                                    <div class="row">
										<div class="col-md-3">
                                            <div class="form-group">
                                                <label>BOARD</label>
                                                <input type="text" class="form-control" placeholder="HSLC BOARD" name="hslcB" value="<?php echo $row1["hslcB"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>INSTITUTE</label>
                                                <input type="text" class="form-control" placeholder="INSTITUTE NAME" name="hslcI" value="<?php echo $row1["hslcI"]; ?>" required>
                                            </div>
                                        </div>
										<div class="col-md-3">
                                            <div class="form-group">
                                                <label>YEAR OF PASSING</label>
                                                <input type="number" class="form-control" placeholder="YEAR OF PASSING" name="hslcY" value="<?php echo $row1["hslcY"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>PERCENTAGE</label>
                                                <input type="number" min="1" max="100" step=".01" class="form-control" placeholder="PERCENTAGE" name="hslcP"  value="<?php echo $row1["hslcP"]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									<h5>HS DETAILS</h5>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<select name="hsS" class="form-control" required>
													<option value="<?php echo $row1["hsS"]; ?>"><?php echo $row1["hsS"]; ?> </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>BOARD</label>
                                                <input type="text" class="form-control" placeholder="HS BOARD" name="hsB" value="<?php echo $row1["hsB"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>INSTITUTE</label>
                                                <input type="text" class="form-control" placeholder="INSTITUTE NAME" name="hsI" value="<?php echo $row1["hsI"]; ?>" required>
                                            </div>
                                        </div>
										<div class="col-md-3">
                                            <div class="form-group">
                                                <label>YEAR OF PASSING</label>
                                                <input type="number" class="form-control" placeholder="YEAR OF PASSING" name="hsY" value="<?php echo $row1["hsY"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>PERCENTAGE</label>
                                                <input type="number" min="1" max="100" step=".01" class="form-control" placeholder="PERCENTAGE" name="hsP" value="<?php echo $row1["hsP"]; ?>" required>
                                            </div>
                                        </div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="gD" id="gD" class="form-control">
													<option value="<?php echo $row1["gD"]; ?>"><?php echo $row1["gD"]; ?></option>
													<option value="ba">BA</option>
													<option value="bca">BCA</option>
													<option value="bsc">BSC</option>
												</select>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="gM" id="gM" class="form-control">
													<option value="<?php echo $row1["gM"]; ?>" ><?php echo $row1["gM"]; ?></option>
												</select>
											</div>
										</div>
									...
									<div class="row" id="gDiv2">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="gU" class="form-control" placeholder="UNIVERSITY NAME" name="gU" value="<?php echo $row1["gU"]; ?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>INSTITUTE</label>
                                                <input type="text" id="gI" class="form-control" placeholder="INSTITUTE NAME" name="gI" value="<?php echo $row1["gI"]; ?>" >
                                            </div>
                                        </div>
										<div class="col-md-3">
                                            <div class="form-group">
                                                <label>YEAR OF PASSING</label>
                                                <input type="number" id="gY" class="form-control" placeholder="YEAR OF PASSING" name="gY" value="<?php echo $row1["gY"]; ?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>PERCENTAGE</label>
                                                <input type="number" min="1" max="100" step=".01" id="gP" class="form-control" placeholder="PERCENTAGE" name="gP" value="<?php echo $row1["gP"]; ?>" >
                                            </div>
                                        </div>
